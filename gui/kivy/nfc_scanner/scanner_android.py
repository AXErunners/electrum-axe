...
from electrum_axe_gui.kivy.nfc_scanner import NFCBase
...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        return NdefRecord.createApplicationRecord(
            JString("org.electrum_axe.electrum_axe_develop.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "org.electrum_axe.electrum_axe_develop"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "org.electrum_axe_electrum_axe.electrum_axe_develop:externalType",
                '',
                data)
        return extRecord
    ...
    def _nfc_enable_ndef_exchange(self, data):
        ...
        ndef_record = NdefRecord(
                ...
                'org.electrum_axe.electrum_axe_develop.kivy', '', data)
