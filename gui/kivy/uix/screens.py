...
from electrum_axe.util import profiler, parse_URI, format_time, InvalidPassword, NotEnoughFunds
from electrum_axe import bitcoin
from electrum_axe.util import timestamp_to_datetime
...
class ReceiveScreen(CScreen):
    ...
    def get_URI(self):
        from electrum_axe.util import create_URI
