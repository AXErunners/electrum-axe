...
from electrum_axe.util import make_dir, InvalidPassword, UserCancelled
from electrum_axe.gui.qt.util import (read_QIcon, EnterButton, WWLabel, icon_path,
                                       WindowModalDialog, Buttons, CloseButton, OkButton)
from electrum_axe.gui.qt.qrtextedit import ScanQRTextEdit
from electrum_axe.gui.qt.main_window import StatusBarButton
...
class Plugin(RevealerPlugin):
    ...
    def password_dialog(self, msg=None, parent=None):
        from electrum_axe.gui.qt.password_dialog import PasswordDialog
    ...
    def calibration_pdf(self, image):
        ...
        painter.drawText(700, 2277, _("2. Align your Revealer borderlines to the axeed lines on the top and left."))
