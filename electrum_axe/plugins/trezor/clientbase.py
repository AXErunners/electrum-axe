...
from electrum_axe.util import PrintError, UserCancelled, UserFacingException
from electrum_axe.keystore import bip39_normalize_passphrase
from electrum_axe.bip32 import serialize_xpub, convert_bip32_path_to_list_of_uint32 as parse_path
...
class TrezorClientBase(PrintError):
    ...
    def has_usable_connection_with_device(self):
        ...
        try:
            res = self.client.ping("electrum-axe pinging device")
            assert res == "electrum-axe pinging device"
    ...
    def get_passphrase(self):
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the Axe coins in the wallet.").format(self.device)
        else:
