...
source.exclude_dirs = bin, build, dist, contrib, electrum_axe/gui/qt, electrum_axe/gui/kivy/tools, electrum_axe/gui/kivy/theming/light
...
icon.filename = %(source.dir)s/icons/electrum-axe.png
