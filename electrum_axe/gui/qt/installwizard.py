...
from electrum_axe.wallet import Wallet, Abstract_Wallet
from electrum_axe.storage import WalletStorage
from electrum_axe.util import UserCancelled, InvalidPassword, WalletFileException
...
WIF_HELP_TEXT = (_('WIF keys are typed in Axe Electrum, based on script type.') + '\n\n' +
                 _('A few examples') + ':\n' +
...
MSG_PASSPHRASE_WARN_ISSUE4566 = _("Warning") + ": "\
                              ...
                              + _("Due to a bug, old versions of Axe Electrum will NOT be creating the "
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config, app, plugins):
        ...
        self.set_icon('electrum-axe.png')
        self.show()
        self.raise_()
