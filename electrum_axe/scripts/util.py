...
from electrum_axe.network import parse_servers
from collections import defaultdict

# electrum_axe.util.set_verbosity(1)
...
def get_peers():
    ...
    if server is None:
        print("You need to set a secure server, for example (for mainnet): 'electrum-axe setconfig server helicarrier.bauerj.eu:50002:s'")
        return []
