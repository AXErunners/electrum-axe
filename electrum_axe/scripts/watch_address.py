...
from electrum_axe.util import print_msg, create_and_start_event_loop
from electrum_axe.synchronizer import SynchronizerBase


try:
    addr = sys.argv[1]
except Exception:
    print("usage: watch_address <axe_address>")
    sys.exit(1)
